...
//This file smears a histogram (the histogram is from firing 100MeV photons straight into CATS) and then fits it to a Landau curve.

#include "TF1.h"
#include "TMath.h"
#include "TTreeReader.h"

void H100MeVLAsmearM()
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	TF1 *graph_function = new TF1("graph_function", "[0]*TMath::Landau([1]-x, [2], [3])", 85, 105);

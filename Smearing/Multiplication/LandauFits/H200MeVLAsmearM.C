...
//This file smears a histogram (the histogram is from firing 200MeV photons straight into CATS) and then fits it to a Landau curve.

#include "TF1.h"
#include "TMath.h"
#include "TTreeReader.h"

void H200MeVLAsmearM()
{
	...
	TString filename = "~/G4CATS2024/Out/200MeV.root";
	...
	//Create histogram
	TH1F *h1 = new TH1F("Histogram 2 Statistics", "", 300, 180, 210);
	...
	TH1F *h2 = new TH1F("Histogram 1 Statistics", "", 300, 180, 210);
	while (r2.Next())
	{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//Fitting Histogram to a Landau curve
	//Defining Landau curve
	//Note that the parameters don't really matter, since they are determined by the system when the curve is fitted to the histogram.
	TF1 *graph_function = new TF1("graph_function", "[0]*TMath::Landau([1]-x, [2], [3])", 180, 210);
	
	//Parameter [0] is the scaling factor (amplitude) of the Landau curve
	graph_function->SetParameter(0, 1);
	//Parameter [1] is the mean of the Landau curve
	graph_function->SetParameter(1, h1->GetMean());
	//Parameter [2] is the standard deviation of the Landau curve
	graph_function->SetParameter(2, h1->GetStdDev());
	//Parameter [3] has to do with something...
	graph_function->SetParameter(3, 0);

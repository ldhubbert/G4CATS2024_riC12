...
//This file smears a histogram (the histogram is from firing 200MeV photons straight into CATS) and then fits it to a skewed Gaussian curve.

#include "TF1.h"
#include "TMath.h"
#include "TTreeReader.h"

Double_t MyMethod2(Double_t *x, Double_t *par)
{
...
void H200MeVSKGsmearM()
{
	...
	TF1 *graph_function = new TF1("graph_function", MyMethod2, 180, 210, 6);

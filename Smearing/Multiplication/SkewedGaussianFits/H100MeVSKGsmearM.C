...
//This file smears a histogram (the histogram is from firing 100MeV photons straight into CATS) and then fits it to a skewed Gaussian curve. 
...
void H100MeVSKGsmearM()
{
	...
	c1->cd(2);
	TString FWHM_string;
	FWHM_string = Form("FWHM: %lf", FinalWidth);
